...
<html>
    <head>
        ...
        <meta name="author" content="Forex Indicator System Thailand">
        ...
        <div id="main">
            ...
            <header class="navbar navbar-fixed-top bg-primary">
                <div class="navbar-branding bg-primary">
                    <a class="navbar-brand" href="dashboard.html"> <b>Forex</b>Indicator </a>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown dropdown-item-slide">
                        ...
                        <ul class="dropdown-menu dropdown-hover dropdown-persist pn w350 bg-white animated animated-shorter fadeIn" role="menu">
                            ...
                            <li class="p10 br-t item-1">
                                <div class="media">
                                    <a class="media-left" href="#"> <img src="<?= asset_url() ?>/img/avatars/7.jpg" class="mw40" alt="holder-img"> </a>
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown"> <img src="<?= asset_url() ?>/img/avatars/5.jpg" alt="avatar" class="mw30 br64 mr15">
                            <span>Admin</span>
                        ...
                        <ul class="dropdown-menu dropdown-persist pn w250 bg-white" role="menu">
                            ...
                            <li class="br-t of-h">
                                <?=
                                anchor('auth/logout', '<span class="fa fa-power-off pr5"></span> Logout', 'class="fw600 p12 animated animated-short fadeInDown"')
                                ?>
                            </li>
                        </ul>
                    </li>
