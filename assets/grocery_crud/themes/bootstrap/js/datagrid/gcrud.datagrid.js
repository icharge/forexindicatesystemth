/*global jQuery, console, setTimeout, ajax_list_url */
(function ($) {
    "use strict";
    ...
    Datagrid.prototype.listenerPerPage = function () {
        ...
        datagrid_object.gcrud_container.find('.per_page').change(function () {
    ...
    Datagrid.prototype.SearchAndOrderingTrigger = function () {
        var order_by = $('.column-with-ordering.active:first').data('order-by'),
            ...
            per_page_value = datagrid_object.gcrud_container.find('.per_page').val(),
            data_to_send = {};
        ...
        data_to_send = {
            ...
            per_page: gcrud_container.find('.per_page').val(),
    ...
    Datagrid.prototype.listenerDeleteButton = function () {
        var datagrid_object = this;
    ...
    Datagrid.prototype.calculationsBeforeDelete = function (total_deleted_records) {
        var datagrid_object = this,
            ...
            my_current_per_page = parseInt(datagrid_object.gcrud_container.find('.per_page').val(), 10);
    ...
    Datagrid.prototype.listenerLoadMoreButton = function () {
        ...
        //datagrid_object.gcrud_container.find('table.grocery-crud-table>tbody .dropdown').on('show.bs.dropdown', function () {
            //alert('aa');
            $('.delete-row').click(function (event) {
                event.preventDefault();
