    ...
    <tr>
        ...
        <td>
                <div class="only-desktops"  style="white-space: nowrap">
                    <?php if(!$unset_edit){?>
                        <a class="btn btn-default btn-sm" href="<?php echo $row->edit_url?>" title="<?php echo $this->l('list_edit'); ?>"><i class="fa fa-pencil"></i></a>
                    <?php } ?>
                    <?php if (!$unset_read) { ?>
                        <a class="btn btn-default btn-sm" href="<?php echo $row->read_url?>" title="<?php echo $this->l('list_view')?>"><i class="fa fa-eye"></i></a>
                    <?php } ?>
                    <?php if (!$unset_delete) { ?>
                        <a class="btn btn-danger btn-sm delete-row" data-target="<?php echo $row->delete_url?>" href="javascript:void(0)" title="<?php echo $this->l('list_delete')?>">
                                ...
                                foreach($row->action_urls as $action_unique_id => $action_url){
                                    ...
                                    <li>
                                        <a href="<?php echo $action_url; ?>">
                                            <i class="fa <?php echo $action->css_class; ?>"></i> <?php echo $action->label?></a>
                                        </a>
                                    </li>
                                <?php } ?>
                        </ul>
